...
public class CustomerEntity {
    ...
    public static final String COLM_CONTACT_NAME = "contact_name";
    public static final String COLM_CONTACT_NUMBER = "contact_number";
    public static final String COLM_CONTACT_MOBILE_NUMBER = "contact_mobile_number";
    public static final String COLM_FAX_NUMBER = "fax_number";
    public static final String COLM_POSTAL_CODE = "postal_code";
    public static final String COLM_ADDRESS = "address";
    public static final String COLM_TAX_ID = "tax_id";
    public static final String COLM_RECEIVER = "receiver";
    public static final String COLM_NOTE = "note";


    @Id
    @Column(name = COLM_CUSTOMER_ID, nullable = false)
    String customerId;

    @Column(name = COLM_NAME)
    String name;

    @Column(name = COLM_CONTACT_NAME)
    String contactName;

    @Column(name = COLM_CONTACT_NUMBER)
    String contactNumber;

    @Column(name = COLM_CONTACT_MOBILE_NUMBER)
    String contactMobileNumber;

    @Column(name = COLM_FAX_NUMBER)
    String faxNumber;

    @Column(name = COLM_POSTAL_CODE)
    String postalCode;

    @Column(name = COLM_ADDRESS)
    String address;

    @Column(name = COLM_TAX_ID)
    String taxId;

    @Column(name = COLM_RECEIVER)
    String receiver;
